...
<!-- Create Account for new Users -->
 ...
 <a href="Admin_home.php" title="<?= __('Close')?>"><img src="images/close.jpg"></a></div>
     ...
     <div><center><form action="Resident_create.php" method="post" onsubmit="return validate()">
     ...
     <label><b><?= __('Account Type')?></b></label>&nbsp;&nbsp;&nbsp;<select name="privilege" readonly="readonly"><option>Resident</option></select><br><br>
     ...
     <input type="reset" name="cancel" style="background-color: red;border-radius: 40px;width: 120px;height: 35px;" value="<?= __('cancel')?>"> <br><br><br>  <br><br>
      ...
      mysqli_select_db($db,"rms_db");
        ...
        if (isset($_POST['submit'])){
           ...
           $qry= "select * from resident_acc where user_Id='$user_id'";
     ...
     <script>
          ...
          elseif($username == ""){
             ...
             mysqli_query($db,"insert into resident_acc(user_Id,username,password,privilege,phone_no,state)
